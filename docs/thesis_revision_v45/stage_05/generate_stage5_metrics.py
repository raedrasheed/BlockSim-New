"""Generate the Stage-5 adversarial + incentive evidence metrics from REAL executions.

Every number in STAGE_05_ADVERSARIAL_INCENTIVE_METRICS.json and stage5_metrics.json is produced
...
Run:  python docs/thesis_revision_v45/stage_05/generate_stage5_metrics.py
"""
...
def main() -> None:
    ...
    doc = {
        ...
        "generator": "docs/thesis_revision_v45/stage_05/generate_stage5_metrics.py",
    ...
    for out in (here / "STAGE_05_ADVERSARIAL_INCENTIVE_METRICS.json",
                here / "evidence" / "stage5_metrics.json"):
