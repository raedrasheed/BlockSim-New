"""Stage 5B1G.1 internal freeze-INPUT manifest (for freeze #6).

Created BEFORE the corrective commit. Records the frozen inputs and the INTENDED
freeze branch name (thesis-v43-stage5b2-freeze-6) with contains_own_commit_sha:false.
The authoritative commit SHA is recorded externally (completion report + new remote
freeze branch) after the commit exists. All earlier freeze branches (freeze-1 ..
freeze-5) are PRESERVED unchanged; freeze-5 is explicitly marked invalid for
execution.
"""
...
INTENDED_FREEZE_BRANCH = "thesis-v43-stage5b2-freeze-6"
SUPERSEDES = "thesis-v43-stage5b2-freeze-5"
...
SELF_REFERENCE_NOTE = ("This internal manifest does NOT contain the SHA of the commit "
                       ...
                       "Stage-5B1G.1 completion report.")
...
def build_freeze_inputs(test_result: str = "unverified") -> dict:
    ...
    sp = os.path.join(RESULTS, "raw", "matrix_5b1g1_summary.json")
