"""Stage 8X-ND — fresh seed registry, disjoint from Stage 8X/8Y/8Z.

30 fresh paired primary seeds and 2 dedicated Pilot seeds, derived
deterministically from a Stage-8X-ND-specific master label so the registry is
...
_MASTER_LABEL = "BlockSim-PoCol-stage8xnd-2026-nonce-domain-partitioning"
...
_EARLIER_REGISTRIES = [
    ...
    "experiments/stage8xnr/outputs/stage8x_nr_seeds.json",
    "experiments/stage8xe50/outputs/stage8xe50_seeds.json",
]
