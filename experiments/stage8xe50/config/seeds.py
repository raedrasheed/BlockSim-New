"""Stage 8X-E50 — fresh seed registry, disjoint from Stage 8X/8Y/8Z.

30 fresh paired primary seeds and 2 dedicated Pilot seeds, derived
deterministically from a Stage-8X-E50-specific master label so the registry is
...
_MASTER_LABEL = "BlockSim-PoCol-stage8xe50-2026-common-template-energy"
